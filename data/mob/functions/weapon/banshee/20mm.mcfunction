...
#召喚
summon minecraft:area_effect_cloud ~ ~ ~ {NoGravity:1,Tags:[projectile,gun,20mm,gun-init,tracer-red,mob-gun,entity-nohit],Duration:20,CustomName:"{\"text\":\"gun-r\",\"color\":\"aqua\"}"}
