#召喚
summon phantom ~ ~ ~ {Health:60f,Attributes:[{Name:generic.maxHealth,Base:60}],Glowing:0,CustomName:"{\"text\":\"バンシー\"}",Tags:[banshee,no-burn,banshee-init,enemy-plane,enemy,has-size,size30,dog-fight],Size:35,PersistenceRequired:1b,Passengers:[{id:"minecraft:skeleton",PersistenceRequired:1b,Glowing:0,Tags:[enemy-rider,banshee-rider,banshee-init,enemy],ArmorItems:[{},{},{},{id:"minecraft:diamond_helmet",Count:1b}]}]}
