#召喚
summon phantom ~ ~ ~ {Health:120f,Attributes:[{Name:generic.maxHealth,Base:120}],Glowing:0,CustomName:"{\"text\":\"ファントムI\"}",Tags:[phantom1-tutorial,no-burn,phantom1-init,enemy-plane,enemy,has-size,size30,dog-fight],Size:30,PersistenceRequired:1b,Passengers:[{id:"minecraft:skeleton",PersistenceRequired:1b,Glowing:0,Tags:[phantom1-rider,phantom1-init,enemy,enemy-rider],ArmorItems:[{},{},{},{id:"minecraft:diamond_helmet",Count:1b}]}]}
