...
scoreboard players set @e[tag=big-phantom1-init] pitch-speed 170
scoreboard players set @e[tag=big-phantom1-init] yaw-speed 170
...
scoreboard players set @e[tag=big-phantom1-init] skill-ct 200
scoreboard players set @e[tag=big-phantom1-init] max-skill-ct 200
