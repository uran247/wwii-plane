...
execute at 0-0-20-0-0 run tp 0-0-21-0-0 ^ ^ ^5
execute store result score #sin return run data get entity 0-0-21-0-0 Pos[0] -200
execute store result score #cos return run data get entity 0-0-21-0-0 Pos[2] 200
