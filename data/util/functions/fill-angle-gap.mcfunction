...
execute if score #delta-angle input >= #1 Num if score #delta-angle input <= #change-ammount input run scoreboard players operation #delta-angle return = #delta-angle input

#delta-angleが0以下なら判定のためchange-ammountを反転
execute if score #delta-angle input <= #0 Num run scoreboard players operation #inv-change-ammount input = #change-ammount input
execute if score #delta-angle input <= #0 Num run scoreboard players operation #inv-change-ammount input *= #-1 Num
...
execute if score #delta-angle input <= #-1 Num if score #delta-angle input >= #inv-change-ammount input run scoreboard players operation #delta-angle return = #delta-angle input
