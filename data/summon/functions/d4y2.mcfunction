...
#機体召喚
summon minecraft:armor_stand ~ ~ ~ {Invisible:1,NoGravity:0,Tags:[d4y2-root,d4y2,plane-init,plane-root,plane,entity-nohit,bombed,normal,250kg,60kg,has-weapon1,has-weapon2,has-weapon3,main-weapon1,main-weapon2,tier2],CustomName:"{\"text\":\"d4y2\"}",Pose:{LeftArm:[0f,0f,0f],RightArm:[0f,0f,0f]},DisabledSlots:256,NoGravity:0b}
summon minecraft:armor_stand ~ ~ ~ {Invisible:1,NoGravity:0,Tags:[d4y2,plane-init,plane,entity-nohit,plane-seat],CustomName:"{\"text\":\"seat\"}",Pose:{LeftArm:[0f,0f,0f],RightArm:[0f,0f,0f]},Passengers:[{id:donkey,DeathLootTable:"minecraft:entities/bat",SaddleItem:{id:"minecraft:saddle",Count:1b},Tame:1,NoAI:1,Silent:1,ChestedHorse:1b,ActiveEffects:[{Id:14,Amplifier:0,Duration:1000000,ShowParticles:0b}],Tags:[d4y2,plane-init,plane,plane-seat,entity-nohit]}],DisabledSlots:256,NoGravity:0b}
...
#hitbox召喚
summon armor_stand ~ ~ ~ {Tags:["d4y2-hitbox","d4y2",plane-init,has-offset,plane,plane-hitbox,body,offset-base],NoGravity:1b,Invisible:1,Marker:1,Glowing:1,CustomName:"{\"text\":\"body\"}",Health:80f,Attributes:[{Name:generic.maxHealth,Base:80}]}
summon armor_stand ~ ~ ~ {Tags:["d4y2-hitbox","d4y2",plane-init,has-offset,plane,plane-hitbox,engine,offset-base],NoGravity:1b,Invisible:1,Marker:1,Glowing:1,CustomName:"{\"text\":\"engine\"}",Health:80f,Attributes:[{Name:generic.maxHealth,Base:80}]}
summon armor_stand ~ ~ ~ {Tags:["d4y2-hitbox","d4y2",plane-init,has-offset,plane,plane-hitbox,aileron-r,aileron,offset-base],NoGravity:1b,Invisible:1,Marker:1,Glowing:1,CustomName:"{\"text\":\"aileron-right\"}",Health:80f,Attributes:[{Name:generic.maxHealth,Base:80}]}
summon armor_stand ~ ~ ~ {Tags:["d4y2-hitbox","d4y2",plane-init,has-offset,plane,plane-hitbox,aileron-l,aileron,offset-base],NoGravity:1b,Invisible:1,Marker:1,Glowing:1,CustomName:"{\"text\":\"aileron-left\"}",Health:80f,Attributes:[{Name:generic.maxHealth,Base:80}]}
...
#ID付与
execute as @e[tag=plane-init,tag=d4y2-root,limit=1] store result score @s plane-id run data get entity @s UUIDMost 0.000000000233
scoreboard players operation @e[tag=plane-init,tag=d4y2-root,limit=1,scores={plane-id=..-1}] plane-id *= #-1 Num
scoreboard players operation @e[tag=plane-init] plane-id = @e[tag=plane-init,tag=d4y2-root,limit=1] plane-id
...
scoreboard players set @e[tag=plane-init,tag=d4y2-root] resistance 32
scoreboard players set @e[tag=plane-init,tag=d4y2-root] energy-loss 10
scoreboard players set @e[tag=plane-init,tag=d4y2-root] deaccelerate 89
scoreboard players set @e[tag=plane-init,tag=d4y2-root] max-speed 20100
scoreboard players set @e[tag=plane-init,tag=d4y2-root] cruise-speed 12200
scoreboard players set @e[tag=plane-init,tag=d4y2-root] takeoff-speed 6000
scoreboard players set @e[tag=plane-init,tag=d4y2-root] stall-speed 5800
...
scoreboard players set @e[tag=plane-init,tag=d4y2-root] gear-retract-min 7300
scoreboard players set @e[tag=plane-init,tag=d4y2-root] gear-retract-max 7500
scoreboard players set @e[tag=plane-init,tag=d4y2-root] gear-pullout-min 7000
scoreboard players set @e[tag=plane-init,tag=d4y2-root] gear-pullout-max 7200
...
scoreboard players set @e[tag=plane-init,tag=d4y2-root] yaw-speed 160
scoreboard players set @e[tag=plane-init,tag=d4y2-root] roll-speed 600

scoreboard players set @e[tag=plane-init,tag=d4y2-root] parking-udvm 27
scoreboard players set @e[tag=plane-init,tag=d4y2-root] rolling-udvm 28
scoreboard players set @e[tag=plane-init,tag=d4y2-root] flying-udvm 29
...
scoreboard players set @e[tag=engine,tag=plane-init] offsetY -1400
scoreboard players set @e[tag=engine,tag=plane-init] offsetZ -6000
scoreboard players set @e[tag=aileron-r,tag=plane-init] offsetX -4000
scoreboard players set @e[tag=aileron-r,tag=plane-init] offsetY -1200
scoreboard players set @e[tag=aileron-r,tag=plane-init] offsetZ -3500
scoreboard players set @e[tag=aileron-l,tag=plane-init] offsetX 4000
scoreboard players set @e[tag=aileron-l,tag=plane-init] offsetY -1200
scoreboard players set @e[tag=aileron-l,tag=plane-init] offsetZ -3500
scoreboard players set @e[tag=elevator-r,tag=plane-init] offsetX -1500
scoreboard players set @e[tag=elevator-r,tag=plane-init] offsetY -1500
scoreboard players set @e[tag=elevator-r,tag=plane-init] offsetZ 2200
scoreboard players set @e[tag=elevator-l,tag=plane-init] offsetX 1500
scoreboard players set @e[tag=elevator-l,tag=plane-init] offsetY -1500
scoreboard players set @e[tag=elevator-l,tag=plane-init] offsetZ 2200
scoreboard players set @e[tag=radder,tag=plane-init] offsetX -150
scoreboard players set @e[tag=radder,tag=plane-init] offsetY -2500
scoreboard players set @e[tag=radder,tag=plane-init] offsetZ 2600

#プレイヤーと同じAngYにする
execute at @e[tag=plane-init,tag=d4y2-root,limit=1] store result score @p reg1 run data get entity @p Rotation[0] 100
scoreboard players remove @s[scores={reg1=18100..}] reg1 36000
scoreboard players add @s[scores={reg1=..-18100}] reg1 36000
execute at @e[tag=plane-init,tag=d4y2-root,limit=1] run scoreboard players operation @e[tag=plane-init,tag=d4y2-root,limit=1] AngY = @p reg1
