...
#機体召喚
summon minecraft:armor_stand ~ ~ ~ {Invisible:1,NoGravity:0,Tags:[d3a-root,d3a,d3a-init,plane-root,plane,entity-nohit,bombed,normal,250kg,60kg,has-weapon1,has-weapon2,main-weapon1,main-weapon2,tier1],CustomName:"{\"text\":\"d3a\"}",Pose:{LeftArm:[0f,0f,0f],RightArm:[0f,0f,0f]},DisabledSlots:256,NoGravity:0b}
...
summon armor_stand ~ ~ ~ {Tags:["d3a-body","d3a",d3a-init,plane,has-model,model-changeable,plane-parts,entity-nohit],NoGravity:1b,Invisible:1,HandItems:[{id:"minecraft:diamond_sword",Count:1b,tag:{Damage:73,Unbreakable:1}},{}],Pose:{LeftArm:[0f,0f,0f],RightArm:[0f,0f,0f]},DisabledSlots:256}
...
scoreboard players set @e[tag=d3a-init,tag=d3a-root] plpr-start-max 1530
scoreboard players set @e[tag=d3a-init,tag=d3a-root] plpr-stop-min 1400
scoreboard players set @e[tag=d3a-init,tag=d3a-root] plpr-stop-max 1430
scoreboard players set @e[tag=d3a-init,tag=d3a-root] gear-retract-min 6100
scoreboard players set @e[tag=d3a-init,tag=d3a-root] gear-retract-max 6300
scoreboard players set @e[tag=d3a-init,tag=d3a-root] gear-pullout-min 5800
scoreboard players set @e[tag=d3a-init,tag=d3a-root] gear-pullout-max 6000
...
scoreboard players set @e[tag=d3a-init,tag=d3a-root] roll-speed 390
...
scoreboard players set @e[tag=d3a-init,tag=d3a-root] ammunition2 3
scoreboard players set @e[tag=d3a-init,tag=d3a-root] ammunition3 500
scoreboard players set @e[tag=d3a-init,tag=d3a-root] max-ammunition1 500
scoreboard players set @e[tag=d3a-init,tag=d3a-root] max-ammunition2 3
scoreboard players set @e[tag=d3a-init,tag=d3a-root] max-ammunition3 500
scoreboard players set @e[tag=d3a-init,tag=d3a-root] max-ammo-reload1 140
scoreboard players set @e[tag=d3a-init,tag=d3a-root] max-ammo-reload2 500
scoreboard players set @e[tag=d3a-init,tag=d3a-root] max-ammo-reload3 140
scoreboard players set @e[tag=d3a-init,tag=d3a-root] plane-weapon 1
