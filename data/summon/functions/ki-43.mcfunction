...
#機体召喚
summon minecraft:armor_stand ~ ~ ~ {Invisible:1,NoGravity:0,Tags:[ki43-root,ki43,ki43-init,plane-root,plane,entity-nohit,"7p7mm",has-weapon1,tier1,main-weapon1],CustomName:"{\"text\":\"ki43\"}",Pose:{LeftArm:[0f,0f,0f],RightArm:[0f,0f,0f]},DisabledSlots:256,NoGravity:0b}
...
summon armor_stand ~ ~ ~ {Tags:["ki43-hitbox","ki43",ki43-init,plane,plane-hitbox,has-offset,engine,offset-base],NoGravity:1b,Invisible:1,Marker:1,Glowing:1,CustomName:"{\"text\":\"engine\"}",Health:80f,Attributes:[{Name:generic.maxHealth,Base:80}]}
summon armor_stand ~ ~ ~ {Tags:["ki43-hitbox","ki43",ki43-init,plane,plane-hitbox,has-offset,aileron-r,aileron,offset-base],NoGravity:1b,Invisible:1,Marker:1,Glowing:1,CustomName:"{\"text\":\"aileron-right\"}",Health:80f,Attributes:[{Name:generic.maxHealth,Base:80}]}
summon armor_stand ~ ~ ~ {Tags:["ki43-hitbox","ki43",ki43-init,plane,plane-hitbox,has-offset,aileron-l,aileron,offset-base],NoGravity:1b,Invisible:1,Marker:1,Glowing:1,CustomName:"{\"text\":\"aileron-left\"}",Health:80f,Attributes:[{Name:generic.maxHealth,Base:80}]}
...
scoreboard players set @e[tag=ki43-init,tag=ki43-root,tag=7p7mm] max-ammunition1 500
scoreboard players set @e[tag=ki43-init,tag=ki43-root,tag=12p7mm] max-ammunition1 270
scoreboard players set @e[tag=ki43-init,tag=ki43-root,tag=7p7mm] max-ammo-reload1 140
scoreboard players set @e[tag=ki43-init,tag=ki43-root,tag=12p7mm] max-ammo-reload1 210
...
scoreboard players set @e[tag=engine,tag=ki43-init] offsetY -100
scoreboard players set @e[tag=engine,tag=ki43-init] offsetZ -1500
scoreboard players set @e[tag=aileron-r,tag=ki43-init] offsetX -3000
scoreboard players set @e[tag=aileron-r,tag=ki43-init] offsetY 0
scoreboard players set @e[tag=aileron-r,tag=ki43-init] offsetZ -100
scoreboard players set @e[tag=aileron-l,tag=ki43-init] offsetX 3000
scoreboard players set @e[tag=aileron-l,tag=ki43-init] offsetY 0
scoreboard players set @e[tag=aileron-l,tag=ki43-init] offsetZ -100
scoreboard players set @e[tag=elevator-r,tag=ki43-init] offsetX -1500
scoreboard players set @e[tag=elevator-r,tag=ki43-init] offsetY -300
scoreboard players set @e[tag=elevator-r,tag=ki43-init] offsetZ 5400
scoreboard players set @e[tag=elevator-l,tag=ki43-init] offsetX 1300
scoreboard players set @e[tag=elevator-l,tag=ki43-init] offsetY -300
scoreboard players set @e[tag=elevator-l,tag=ki43-init] offsetZ 5400
scoreboard players set @e[tag=radder,tag=ki43-init] offsetX -100
scoreboard players set @e[tag=radder,tag=ki43-init] offsetY -1000
scoreboard players set @e[tag=radder,tag=ki43-init] offsetZ 5400
