...
#### 60kg爆弾1個目召喚 ####
execute if entity @s[tag=60kg,tag=normal] run summon armor_stand ~ ~ ~ {Tags:["d3a-bomb-right","d3a",d3a-init,plane,plane-bomb,plane-parts,entity-nohit,60kg,bomb-normal],NoGravity:1b,Invisible:1,HandItems:[{id:"minecraft:diamond_sword",Count:1b,tag:{Damage:76,Unbreakable:1}},{}],Pose:{RightArm:[0f,0f,0f]},DisabledSlots:256}
#スコアセット
...
#### 60kg爆弾2個目召喚 ####
execute if entity @s[tag=60kg,tag=normal] run summon armor_stand ~ ~ ~ {Tags:["d3a-bomb-left","d3a",d3a-init,plane,plane-bomb,plane-parts,entity-nohit,60kg,bomb-normal],NoGravity:1b,Invisible:1,HandItems:[{id:"minecraft:diamond_sword",Count:1b,tag:{Damage:76,Unbreakable:1}},{}],Pose:{RightArm:[0f,0f,0f]},DisabledSlots:256}
...
#### 250kg爆弾1個目召喚 ####
execute if entity @s[tag=250kg,tag=normal] run summon armor_stand ~ ~ ~ {Tags:["d3a-bomb-center","d3a",d3a-init,plane,plane-bomb,plane-parts,entity-nohit,250kg,bomb-normal],NoGravity:1b,Invisible:1,HandItems:[{id:"minecraft:diamond_sword",Count:1b,tag:{Damage:77,Unbreakable:1}},{}],Pose:{RightArm:[0f,0f,0f]},DisabledSlots:256}
