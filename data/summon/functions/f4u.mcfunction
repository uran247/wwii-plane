...
summon armor_stand ~ ~ ~ {Tags:["f4u-body","f4u",f4u-init,plane,plane-body],NoGravity:1b,Invisible:1,HandItems:[{id:"minecraft:diamond_sword",Count:1b,tag:{Damage:1,Unbreakable:1}},{}],Pose:{LeftArm:[0f,0f,0f],RightArm:[-12f,0f,0f]},DisabledSlots:256}
summon armor_stand ~ ~ ~ {Tags:["f4u-wing-r","f4u",f4u-init,plane,plane-parts,f4u-wing],NoGravity:1b,Invisible:1,HandItems:[{id:"minecraft:diamond_sword",Count:1b,tag:{Damage:64,Unbreakable:1}},{}],Pose:{LeftArm:[0f,0f,0f],RightArm:[-12f,0f,0f]},DisabledSlots:256}
summon armor_stand ~ ~ ~ {Tags:["f4u-wing-l","f4u",f4u-init,plane,plane-parts,f4u-wing],NoGravity:1b,Invisible:1,HandItems:[{id:"minecraft:diamond_sword",Count:1b,tag:{Damage:65,Unbreakable:1}},{}],Pose:{LeftArm:[0f,0f,0f],RightArm:[-12f,0f,0f]},DisabledSlots:256}
...
scoreboard players set @e[tag=f4u-init,tag=f4u-root] max-speed 1960
...
scoreboard players set @e[tag=f4u-init,tag=f4u-root] ammunition1 200
scoreboard players set @e[tag=f4u-init,tag=f4u-root] ammunition1 1000

#パーツのオフセット位置設定
scoreboard players set @e[tag=f4u-wing-r,tag=f4u-init] offsetX -1860
scoreboard players set @e[tag=f4u-wing-r,tag=f4u-init] offsetY 0
scoreboard players set @e[tag=f4u-wing-r,tag=f4u-init] offsetZ 0
scoreboard players set @e[tag=f4u-wing-l,tag=f4u-init] offsetX 2620
scoreboard players set @e[tag=f4u-wing-l,tag=f4u-init] offsetY 0
