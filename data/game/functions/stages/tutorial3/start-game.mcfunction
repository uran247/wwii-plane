...
function game:stages/tutorial3/start-game/forceload
function game:stages/tutorial3/start-game/set-bossbar
function game:stages/tutorial3/start-game/move-to-stage
function game:stages/tutorial3/start-game/show-message
