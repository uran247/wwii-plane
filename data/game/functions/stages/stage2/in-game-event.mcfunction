...
execute if score #phase event-flag matches 3 as @a positioned -2372 250 -1654 unless entity @s[distance=..378] run function game:in-game-event/util/show-direction
