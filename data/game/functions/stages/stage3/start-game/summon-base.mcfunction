#基地召喚&定位置へ移動
summon minecraft:armor_stand 0 0 0 {Invisible:1b,Tags:[enemy-target,enemy-base,base,entity-nohit],HandItems:[{id:"minecraft:snowball",Count:1b,tag:{BaseHP:10000}},{}]}
