...
function game:stages/tutorial2/start-game/forceload
function game:stages/tutorial2/start-game/set-bossbar
function game:stages/tutorial2/start-game/move-to-stage
function game:stages/tutorial2/start-game/show-message
