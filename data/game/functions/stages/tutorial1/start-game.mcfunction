...
function game:stages/tutorial1/start-game/forceload
function game:stages/tutorial1/start-game/set-bossbar
function game:stages/tutorial1/start-game/move-to-stage
function game:stages/tutorial1/start-game/show-message
