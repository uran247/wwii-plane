...
#機体召喚
summon minecraft:armor_stand ~ ~ ~ {Invisible:1,NoGravity:0,Tags:[a6m2-root,a6m2,plane-init,plane-root,plane,entity-nohit,has-weapon1,has-weapon2,main-weapon1,main-weapon2,tier2],CustomName:"{\"text\":\"a6m2\"}",Pose:{LeftArm:[0f,0f,0f],RightArm:[0f,0f,0f]},DisabledSlots:256,NoGravity:0b,HandItems:[{id:"minecraft:stone_button",Count:1b,tag:{weapons:["20mm gun","7.7mm gun"]}},{}]}
summon minecraft:armor_stand ~ ~ ~ {Invisible:1,NoGravity:0,Tags:[a6m2,plane-init,plane,entity-nohit,plane-seat],CustomName:"{\"text\":\"seat\"}",Pose:{LeftArm:[0f,0f,0f],RightArm:[0f,0f,0f]},Passengers:[{id:donkey,Invulnerable:1b,DeathLootTable:"minecraft:entities/bat",SaddleItem:{id:"minecraft:saddle",Count:1b},Tame:1,NoAI:1,Silent:1,ChestedHorse:1b,ActiveEffects:[{Id:14,Amplifier:0,Duration:1000000,ShowParticles:0b}],Tags:[a6m2,plane-init,plane,plane-seat,entity-nohit]}],DisabledSlots:256,NoGravity:0b}
...
summon armor_stand ~ ~ ~ {Tags:["a6m2-hitbox","a6m2",plane-init,plane,plane-hitbox,has-offset,body,offset-base],NoGravity:1b,Invisible:1,Marker:1,Glowing:1,CustomName:"{\"text\":\"body\"}",Health:120f,Attributes:[{Name:generic.maxHealth,Base:120}]}
summon armor_stand ~ ~ ~ {Tags:["a6m2-hitbox","a6m2",plane-init,plane,plane-hitbox,has-offset,engine,offset-base],NoGravity:1b,Invisible:1,Marker:1,Glowing:1,CustomName:"{\"text\":\"engine\"}",Health:120f,Attributes:[{Name:generic.maxHealth,Base:120}]}
summon armor_stand ~ ~ ~ {Tags:["a6m2-hitbox","a6m2",plane-init,plane,plane-hitbox,has-offset,aileron-r,aileron,offset-base],NoGravity:1b,Invisible:1,Marker:1,Glowing:1,CustomName:"{\"text\":\"aileron-right\"}",Health:120f,Attributes:[{Name:generic.maxHealth,Base:120}]}
summon armor_stand ~ ~ ~ {Tags:["a6m2-hitbox","a6m2",plane-init,plane,plane-hitbox,has-offset,aileron-l,aileron,offset-base],NoGravity:1b,Invisible:1,Marker:1,Glowing:1,CustomName:"{\"text\":\"aileron-left\"}",Health:120f,Attributes:[{Name:generic.maxHealth,Base:120}]}
summon armor_stand ~ ~ ~ {Tags:["a6m2-hitbox","a6m2",plane-init,plane,plane-hitbox,has-offset,elevator-r,elevetor,offset-base],NoGravity:1b,Invisible:1,Marker:1,Glowing:1,CustomName:"{\"text\":\"elevator-right\"}",Health:120f,Attributes:[{Name:generic.maxHealth,Base:120}]}
summon armor_stand ~ ~ ~ {Tags:["a6m2-hitbox","a6m2",plane-init,plane,plane-hitbox,has-offset,elevator-l,elevetor,offset-base],NoGravity:1b,Invisible:1,Marker:1,Glowing:1,CustomName:"{\"text\":\"elevator-left\"}",Health:120f,Attributes:[{Name:generic.maxHealth,Base:120}]}
summon armor_stand ~ ~ ~ {Tags:["a6m2-hitbox","a6m2",plane-init,plane,plane-hitbox,has-offset,radder,offset-base],NoGravity:1b,Invisible:1,Marker:1,Glowing:1,CustomName:"{\"text\":\"radder\"}",Health:120f,Attributes:[{Name:generic.maxHealth,Base:120}]}
summon armor_stand ~ ~ ~ {Tags:["a6m2-hitbox","a6m2",plane-init,plane,plane-hitbox,has-offset,cockpit,offset-base],NoGravity:1b,Invisible:1,Marker:1,Glowing:1,CustomName:"{\"text\":\"radder\"}",Health:120f,Attributes:[{Name:generic.maxHealth,Base:120}]}
...
scoreboard players set @e[tag=plane-init,tag=a6m2-root] weapon-types 2
