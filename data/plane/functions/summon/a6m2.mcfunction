...
scoreboard players set @e[tag=plane-init,tag=a6m2-root] resistance 38
scoreboard players set @e[tag=plane-init,tag=a6m2-root] energy-loss 8
scoreboard players set @e[tag=plane-init,tag=a6m2-root] deaccelerate 81
...
scoreboard players set @e[tag=plane-init,tag=a6m2-root] takeoff-speed 4200
scoreboard players set @e[tag=plane-init,tag=a6m2-root] stall-speed 4000
