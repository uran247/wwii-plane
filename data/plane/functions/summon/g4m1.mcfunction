...
#hitbox召喚
summon armor_stand ~ ~ ~ {Tags:["g4m1-hitbox","g4m1",plane-init,plane,has-offset,plane-hitbox,body,offset-base,has-size,size30],NoGravity:1b,Invisible:1,Marker:1,Glowing:1,CustomName:"{\"text\":\"body\"}",Health:110f,Attributes:[{Name:generic.maxHealth,Base:110}]}
summon armor_stand ~ ~ ~ {Tags:["g4m1-hitbox","g4m1",plane-init,plane,has-offset,plane-hitbox,engine-r,engine,offset-base],NoGravity:1b,Invisible:1,Marker:1,Glowing:1,CustomName:"{\"text\":\"engine\"}",Health:100f,Attributes:[{Name:generic.maxHealth,Base:100}]}
summon armor_stand ~ ~ ~ {Tags:["g4m1-hitbox","g4m1",plane-init,plane,has-offset,plane-hitbox,engine-l,engine,offset-base],NoGravity:1b,Invisible:1,Marker:1,Glowing:1,CustomName:"{\"text\":\"engine\"}",Health:100f,Attributes:[{Name:generic.maxHealth,Base:100}]}
summon armor_stand ~ ~ ~ {Tags:["g4m1-hitbox","g4m1",plane-init,plane,has-offset,plane-hitbox,aileron-r,aileron,offset-base,has-size,size30],NoGravity:1b,Invisible:1,Marker:1,Glowing:1,CustomName:"{\"text\":\"aileron-right\"}",Health:90f,Attributes:[{Name:generic.maxHealth,Base:90}]}
summon armor_stand ~ ~ ~ {Tags:["g4m1-hitbox","g4m1",plane-init,plane,has-offset,plane-hitbox,aileron-l,aileron,offset-base,has-size,size30],NoGravity:1b,Invisible:1,Marker:1,Glowing:1,CustomName:"{\"text\":\"aileron-left\"}",Health:90f,Attributes:[{Name:generic.maxHealth,Base:90}]}
summon armor_stand ~ ~ ~ {Tags:["g4m1-hitbox","g4m1",plane-init,plane,has-offset,plane-hitbox,elevator-r,elevetor,offset-base],NoGravity:1b,Invisible:1,Marker:1,Glowing:1,CustomName:"{\"text\":\"elevator-right\"}",Health:70f,Attributes:[{Name:generic.maxHealth,Base:70}]}
summon armor_stand ~ ~ ~ {Tags:["g4m1-hitbox","g4m1",plane-init,plane,has-offset,plane-hitbox,elevator-l,elevetor,offset-base],NoGravity:1b,Invisible:1,Marker:1,Glowing:1,CustomName:"{\"text\":\"elevator-left\"}",Health:70f,Attributes:[{Name:generic.maxHealth,Base:70}]}
summon armor_stand ~ ~ ~ {Tags:["g4m1-hitbox","g4m1",plane-init,plane,has-offset,plane-hitbox,radder,offset-base],NoGravity:1b,Invisible:1,Marker:1,Glowing:1,CustomName:"{\"text\":\"radder\"}",Health:70f,Attributes:[{Name:generic.maxHealth,Base:70}]}
summon armor_stand ~ ~ ~ {Tags:["g4m1-hitbox","g4m1",plane-init,plane,has-offset,plane-hitbox,cockpit,offset-base],NoGravity:1b,Invisible:1,Marker:1,Glowing:1,CustomName:"{\"text\":\"cockpit\"}",Health:80f,Attributes:[{Name:generic.maxHealth,Base:80}]}
...
scoreboard players set @e[tag=plane-init,tag=g4m1-root] accelerate 37
scoreboard players set @e[tag=plane-init,tag=g4m1-root] resistance 26
scoreboard players set @e[tag=plane-init,tag=g4m1-root] energy-loss 10
scoreboard players set @e[tag=plane-init,tag=g4m1-root] deaccelerate 67
scoreboard players set @e[tag=plane-init,tag=g4m1-root] max-speed 15700
scoreboard players set @e[tag=plane-init,tag=g4m1-root] cruise-speed 10900
scoreboard players set @e[tag=plane-init,tag=g4m1-root] takeoff-speed 3900
scoreboard players set @e[tag=plane-init,tag=g4m1-root] stall-speed 3700
