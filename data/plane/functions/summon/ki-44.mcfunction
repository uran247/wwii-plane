...
summon armor_stand ~ ~ ~ {Tags:["ki44-hitbox","ki44",plane-init,plane,plane-hitbox,has-offset,body,offset-base],NoGravity:1b,Invisible:1,Marker:1,Glowing:1,CustomName:"{\"text\":\"body\"}",Health:160f,Attributes:[{Name:generic.maxHealth,Base:160}]}
summon armor_stand ~ ~ ~ {Tags:["ki44-hitbox","ki44",plane-init,plane,plane-hitbox,has-offset,engine,offset-base],NoGravity:1b,Invisible:1,Marker:1,Glowing:1,CustomName:"{\"text\":\"engine\"}",Health:160f,Attributes:[{Name:generic.maxHealth,Base:160}]}
summon armor_stand ~ ~ ~ {Tags:["ki44-hitbox","ki44",plane-init,plane,plane-hitbox,has-offset,aileron-r,aileron,offset-base],NoGravity:1b,Invisible:1,Marker:1,Glowing:1,CustomName:"{\"text\":\"aileron-right\"}",Health:160f,Attributes:[{Name:generic.maxHealth,Base:160}]}
summon armor_stand ~ ~ ~ {Tags:["ki44-hitbox","ki44",plane-init,plane,plane-hitbox,has-offset,aileron-l,aileron,offset-base],NoGravity:1b,Invisible:1,Marker:1,Glowing:1,CustomName:"{\"text\":\"aileron-left\"}",Health:160f,Attributes:[{Name:generic.maxHealth,Base:160}]}
summon armor_stand ~ ~ ~ {Tags:["ki44-hitbox","ki44",plane-init,plane,plane-hitbox,has-offset,elevator-r,elevetor,offset-base],NoGravity:1b,Invisible:1,Marker:1,Glowing:1,CustomName:"{\"text\":\"elevator-right\"}",Health:160f,Attributes:[{Name:generic.maxHealth,Base:160}]}
summon armor_stand ~ ~ ~ {Tags:["ki44-hitbox","ki44",plane-init,plane,plane-hitbox,has-offset,elevator-l,elevetor,offset-base],NoGravity:1b,Invisible:1,Marker:1,Glowing:1,CustomName:"{\"text\":\"elevator-left\"}",Health:160f,Attributes:[{Name:generic.maxHealth,Base:160}]}
summon armor_stand ~ ~ ~ {Tags:["ki44-hitbox","ki44",plane-init,plane,plane-hitbox,has-offset,radder,offset-base],NoGravity:1b,Invisible:1,Marker:1,Glowing:1,CustomName:"{\"text\":\"radder\"}",Health:160f,Attributes:[{Name:generic.maxHealth,Base:160}]}
summon armor_stand ~ ~ ~ {Tags:["ki44-hitbox","ki44",plane-init,plane,plane-hitbox,has-offset,cockpit,offset-base],NoGravity:1b,Invisible:1,Marker:1,Glowing:1,CustomName:"{\"text\":\"radder\"}",Health:160f,Attributes:[{Name:generic.maxHealth,Base:160}]}
...
scoreboard players set @e[tag=plane-init,tag=ki44-root] weapon-types 1
