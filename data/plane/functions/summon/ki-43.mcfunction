...
summon armor_stand ~ ~ ~ {Tags:["ki43-hitbox","ki43",plane-init,plane,plane-hitbox,has-offset,elevator-r,elevetor,offset-base],NoGravity:1b,Invisible:1,Marker:1,Glowing:1,CustomName:"{\"text\":\"elevator-right\"}",Health:60f,Attributes:[{Name:generic.maxHealth,Base:60}]}
summon armor_stand ~ ~ ~ {Tags:["ki43-hitbox","ki43",plane-init,plane,plane-hitbox,has-offset,elevator-l,elevetor,offset-base],NoGravity:1b,Invisible:1,Marker:1,Glowing:1,CustomName:"{\"text\":\"elevator-left\"}",Health:60f,Attributes:[{Name:generic.maxHealth,Base:60}]}
summon armor_stand ~ ~ ~ {Tags:["ki43-hitbox","ki43",plane-init,plane,plane-hitbox,has-offset,radder,offset-base],NoGravity:1b,Invisible:1,Marker:1,Glowing:1,CustomName:"{\"text\":\"radder\"}",Health:60f,Attributes:[{Name:generic.maxHealth,Base:60}]}
