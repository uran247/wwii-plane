...
summon armor_stand ~ ~ ~ {Tags:["ki43-hitbox","ki43",plane-init,plane,plane-hitbox,has-offset,aileron-r,aileron,offset-base],NoGravity:1b,Invisible:1,Marker:1,Glowing:1,CustomName:"{\"text\":\"aileron-right\"}",Health:80f,Attributes:[{Name:generic.maxHealth,Base:80}]}
summon armor_stand ~ ~ ~ {Tags:["ki43-hitbox","ki43",plane-init,plane,plane-hitbox,has-offset,aileron-l,aileron,offset-base],NoGravity:1b,Invisible:1,Marker:1,Glowing:1,CustomName:"{\"text\":\"aileron-left\"}",Health:80f,Attributes:[{Name:generic.maxHealth,Base:80}]}
summon armor_stand ~ ~ ~ {Tags:["ki43-hitbox","ki43",plane-init,plane,plane-hitbox,has-offset,elevator-r,elevetor,offset-base],NoGravity:1b,Invisible:1,Marker:1,Glowing:1,CustomName:"{\"text\":\"elevator-right\"}",Health:80f,Attributes:[{Name:generic.maxHealth,Base:80}]}
summon armor_stand ~ ~ ~ {Tags:["ki43-hitbox","ki43",plane-init,plane,plane-hitbox,has-offset,elevator-l,elevetor,offset-base],NoGravity:1b,Invisible:1,Marker:1,Glowing:1,CustomName:"{\"text\":\"elevator-left\"}",Health:80f,Attributes:[{Name:generic.maxHealth,Base:80}]}
summon armor_stand ~ ~ ~ {Tags:["ki43-hitbox","ki43",plane-init,plane,plane-hitbox,has-offset,radder,offset-base],NoGravity:1b,Invisible:1,Marker:1,Glowing:1,CustomName:"{\"text\":\"radder\"}",Health:80f,Attributes:[{Name:generic.maxHealth,Base:80}]}
summon armor_stand ~ ~ ~ {Tags:["ki43-hitbox","ki43",plane-init,plane,plane-hitbox,has-offset,cockpit,offset-base],NoGravity:1b,Invisible:1,Marker:1,Glowing:1,CustomName:"{\"text\":\"radder\"}",Health:80f,Attributes:[{Name:generic.maxHealth,Base:80}]}
...
scoreboard players set @e[tag=plane-init,tag=ki43-root] max-speed 17900
scoreboard players set @e[tag=plane-init,tag=ki43-root] cruise-speed 12300
scoreboard players set @e[tag=plane-init,tag=ki43-root] takeoff-speed 4300
scoreboard players set @e[tag=plane-init,tag=ki43-root] stall-speed 4100
scoreboard players set @e[tag=plane-init,tag=ki43-root] accelerate 64
scoreboard players set @e[tag=plane-init,tag=ki43-root] resistance 44
scoreboard players set @e[tag=plane-init,tag=ki43-root] energy-loss 9
scoreboard players set @e[tag=plane-init,tag=ki43-root] deaccelerate 57
...
scoreboard players set @e[tag=plane-init,tag=ki43-root] parking-udvm 67
scoreboard players set @e[tag=plane-init,tag=ki43-root] rolling-udvm 68
scoreboard players set @e[tag=plane-init,tag=ki43-root] flying-udvm 69
...
scoreboard players set @e[tag=plane-init,tag=ki43-root] weapon-types 1
...
#プレイヤーと同じAngYにする
execute at @e[tag=plane-init,tag=ki43-root,limit=1] store result score @p reg1 run data get entity @p Rotation[0] 100
scoreboard players remove @s[scores={reg1=18100..}] reg1 36000
scoreboard players add @s[scores={reg1=..-18100}] reg1 36000
execute at @e[tag=plane-init,tag=ki43-root,limit=1] run scoreboard players operation @e[tag=plane-init,tag=ki43-root,limit=1] AngY = @p reg1
