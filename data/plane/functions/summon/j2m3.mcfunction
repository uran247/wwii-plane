...
summon armor_stand ~ ~ ~ {Tags:["j2m3-hitbox","j2m3",plane-init,plane,plane-hitbox,has-offset,body,offset-base],NoGravity:1b,Invisible:1,Marker:1,Glowing:1,CustomName:"{\"text\":\"body\"}",Health:150f,Attributes:[{Name:generic.maxHealth,Base:150}]}
summon armor_stand ~ ~ ~ {Tags:["j2m3-hitbox","j2m3",plane-init,plane,plane-hitbox,has-offset,engine,offset-base],NoGravity:1b,Invisible:1,Marker:1,Glowing:1,CustomName:"{\"text\":\"engine\"}",Health:150f,Attributes:[{Name:generic.maxHealth,Base:150}]}
summon armor_stand ~ ~ ~ {Tags:["j2m3-hitbox","j2m3",plane-init,plane,plane-hitbox,has-offset,aileron-r,aileron,offset-base],NoGravity:1b,Invisible:1,Marker:1,Glowing:1,CustomName:"{\"text\":\"aileron-right\"}",Health:150f,Attributes:[{Name:generic.maxHealth,Base:150}]}
summon armor_stand ~ ~ ~ {Tags:["j2m3-hitbox","j2m3",plane-init,plane,plane-hitbox,has-offset,aileron-l,aileron,offset-base],NoGravity:1b,Invisible:1,Marker:1,Glowing:1,CustomName:"{\"text\":\"aileron-left\"}",Health:150f,Attributes:[{Name:generic.maxHealth,Base:150}]}
summon armor_stand ~ ~ ~ {Tags:["j2m3-hitbox","j2m3",plane-init,plane,plane-hitbox,has-offset,elevator-r,elevetor,offset-base],NoGravity:1b,Invisible:1,Marker:1,Glowing:1,CustomName:"{\"text\":\"elevator-right\"}",Health:150f,Attributes:[{Name:generic.maxHealth,Base:150}]}
summon armor_stand ~ ~ ~ {Tags:["j2m3-hitbox","j2m3",plane-init,plane,plane-hitbox,has-offset,elevator-l,elevetor,offset-base],NoGravity:1b,Invisible:1,Marker:1,Glowing:1,CustomName:"{\"text\":\"elevator-left\"}",Health:150f,Attributes:[{Name:generic.maxHealth,Base:150}]}
summon armor_stand ~ ~ ~ {Tags:["j2m3-hitbox","j2m3",plane-init,plane,plane-hitbox,has-offset,radder,offset-base],NoGravity:1b,Invisible:1,Marker:1,Glowing:1,CustomName:"{\"text\":\"radder\"}",Health:150f,Attributes:[{Name:generic.maxHealth,Base:150}]}
summon armor_stand ~ ~ ~ {Tags:["j2m3-hitbox","j2m3",plane-init,plane,plane-hitbox,has-offset,cockpit,offset-base],NoGravity:1b,Invisible:1,Marker:1,Glowing:1,CustomName:"{\"text\":\"radder\"}",Health:150f,Attributes:[{Name:generic.maxHealth,Base:150}]}

#ID付与
execute as @e[tag=plane-init,tag=j2m3-root,limit=1] store result score @s plane-id run data get entity @s UUIDMost 0.000000000233
scoreboard players operation @e[tag=plane-init,tag=j2m3-root,limit=1,scores={plane-id=..-1}] plane-id *= #-1 Num
scoreboard players operation @e[tag=plane-init] plane-id = @e[tag=plane-init,tag=j2m3-root,limit=1] plane-id
...
scoreboard players set @e[tag=plane-init,tag=j2m3-root] accelerate 85
scoreboard players set @e[tag=plane-init,tag=j2m3-root] resistance 51
scoreboard players set @e[tag=plane-init,tag=j2m3-root] energy-loss 10
scoreboard players set @e[tag=plane-init,tag=j2m3-root] deaccelerate 94
...
scoreboard players set @e[tag=plane-init,tag=j2m3-root] takeoff-speed 6100
scoreboard players set @e[tag=plane-init,tag=j2m3-root] stall-speed 5900
...
scoreboard players set @e[tag=plane-init,tag=j2m3-root] parking-udvm 93
scoreboard players set @e[tag=plane-init,tag=j2m3-root] rolling-udvm 94
scoreboard players set @e[tag=plane-init,tag=j2m3-root] flying-udvm 95
...
scoreboard players set @e[tag=plane-init,tag=j2m3-root] weapon-types 2
...
scoreboard players set @e[tag=radder,tag=plane-init] offsetY -2000
...
#プレイヤーと同じAngYにする
execute at @e[tag=plane-init,tag=j2m3-root,limit=1] store result score @p reg1 run data get entity @p Rotation[0] 100
scoreboard players remove @s[scores={reg1=18100..}] reg1 36000
scoreboard players add @s[scores={reg1=..-18100}] reg1 36000
execute at @e[tag=plane-init,tag=j2m3-root,limit=1] run scoreboard players operation @e[tag=plane-init,tag=j2m3-root,limit=1] AngY = @p reg1
