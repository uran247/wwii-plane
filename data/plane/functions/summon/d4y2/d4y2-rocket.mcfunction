...
execute if entity @e[tag=d4y2-rocket-right1,tag=d4y2-init] run say 1

#### ロケット2個目召喚 ####
execute if entity @s[tag=rocketted,tag=normal] run summon armor_stand ~ ~ ~ {Tags:["d4y2-rocket-left1","d4y2",d4y2-init,plane,has-offset,has-model,plane-rocket,plane-parts,entity-nohit,10kg,rocket-normal],NoGravity:1b,Invisible:1,HandItems:[{id:"minecraft:diamond_sword",Count:1b,tag:{Damage:106,Unbreakable:1}},{}],Pose:{RightArm:[0f,0f,0f]},DisabledSlots:256}
...
#### ロケット3個目召喚 ####
execute if entity @s[tag=rocketted,tag=normal] run summon armor_stand ~ ~ ~ {Tags:["d4y2-rocket-right2","d4y2",d4y2-init,plane,has-offset,has-model,plane-rocket,plane-parts,entity-nohit,10kg,rocket-normal],NoGravity:1b,Invisible:1,HandItems:[{id:"minecraft:diamond_sword",Count:1b,tag:{Damage:106,Unbreakable:1}},{}],Pose:{RightArm:[0f,0f,0f]},DisabledSlots:256}
#スコアセット
...
#### ロケット4個目召喚 ####
execute if entity @s[tag=rocketted,tag=normal] run summon armor_stand ~ ~ ~ {Tags:["d4y2-rocket-left2","d4y2",d4y2-init,plane,has-offset,has-model,plane-rocket,plane-parts,entity-nohit,10kg,rocket-normal],NoGravity:1b,Invisible:1,HandItems:[{id:"minecraft:diamond_sword",Count:1b,tag:{Damage:106,Unbreakable:1}},{}],Pose:{RightArm:[0f,0f,0f]},DisabledSlots:256}
