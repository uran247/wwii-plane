...
scoreboard players set @e[tag=d4y2-bomb-right,tag=d4y2-init] accelerate-cor -2
...
scoreboard players set @e[tag=d4y2-bomb-left,tag=d4y2-init] accelerate-cor -2
...
scoreboard players set @e[tag=d4y2-bomb-center,tag=d4y2-init] accelerate-cor -2
