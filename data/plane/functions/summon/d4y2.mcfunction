...
#機体召喚
summon minecraft:armor_stand ~ ~ ~ {Invisible:1,NoGravity:0,Tags:[d4y2-root,d4y2,plane-init,plane-root,plane,entity-nohit,need-calc-offset,delay-rotation,bombed,60kg-normal,250kg-normal,has-weapon1,has-weapon2,has-weapon3,has-weapon4,main-weapon1,main-weapon2,main-weapon4,tier2],CustomName:"{\"text\":\"d4y2\"}",Pose:{LeftArm:[0f,0f,0f],RightArm:[0f,0f,0f]},DisabledSlots:256,NoGravity:0b,HandItems:[{id:"minecraft:stone_button",Count:1b,tag:{weapons:["7.7mm gun","bomb","rocket"]}},{}]}
...
scoreboard players set @e[tag=plane-init,tag=d4y2-root] accelerate 65
scoreboard players set @e[tag=plane-init,tag=d4y2-root] resistance 40
scoreboard players set @e[tag=plane-init,tag=d4y2-root] energy-loss 16
scoreboard players set @e[tag=plane-init,tag=d4y2-root] deaccelerate 113
scoreboard players set @e[tag=plane-init,tag=d4y2-root] max-speed 20100
scoreboard players set @e[tag=plane-init,tag=d4y2-root] cruise-speed 12500
