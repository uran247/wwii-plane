...
summon armor_stand ~ ~ ~ {Tags:["d4y2-hitbox","d4y2",plane-init,has-offset,plane,plane-hitbox,cockpit,offset-base],NoGravity:1b,Invisible:1,Marker:1,Glowing:1,CustomName:"{\"text\":\"radder\"}",Health:80f,Attributes:[{Name:generic.maxHealth,Base:80}]}
...
scoreboard players set @e[tag=plane-init,tag=d4y2-root] weapon-types 2
