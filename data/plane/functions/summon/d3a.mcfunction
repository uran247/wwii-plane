...
summon armor_stand ~ ~ ~ {Tags:["d3a-hitbox","d3a",plane-init,has-offset,plane,plane-hitbox,elevator-r,elevetor,offset-base],NoGravity:1b,Invisible:1,Marker:1,Glowing:1,CustomName:"{\"text\":\"elevator-right\"}",Health:80f,Attributes:[{Name:generic.maxHealth,Base:60}]}
summon armor_stand ~ ~ ~ {Tags:["d3a-hitbox","d3a",plane-init,has-offset,plane,plane-hitbox,elevator-l,elevetor,offset-base],NoGravity:1b,Invisible:1,Marker:1,Glowing:1,CustomName:"{\"text\":\"elevator-left\"}",Health:80f,Attributes:[{Name:generic.maxHealth,Base:60}]}
summon armor_stand ~ ~ ~ {Tags:["d3a-hitbox","d3a",plane-init,has-offset,plane,plane-hitbox,radder,offset-base],NoGravity:1b,Invisible:1,Marker:1,Glowing:1,CustomName:"{\"text\":\"radder\"}",Health:80f,Attributes:[{Name:generic.maxHealth,Base:60}]}
summon armor_stand ~ ~ ~ {Tags:["d3a-hitbox","d3a",plane-init,has-offset,plane,plane-hitbox,cockpit,offset-base],NoGravity:1b,Invisible:1,Marker:1,Glowing:1,CustomName:"{\"text\":\"cockpit\"}",Health:80f,Attributes:[{Name:generic.maxHealth,Base:80}]}
...
scoreboard players set @e[tag=plane-init,tag=d3a-root] pitch-speed 180
scoreboard players set @e[tag=plane-init,tag=d3a-root] yaw-speed 130
...
scoreboard players set @e[tag=plane-init,tag=d3a-root] weapon-types 2
