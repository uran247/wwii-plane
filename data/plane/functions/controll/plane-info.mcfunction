...
title @p[tag=controller] actionbar ["",{"score":{"name":"#speed","objective":"reg1"},"color":"red"},{"text":"km/h Throt:","color":"red"},{"score":{"name":"#throttle","objective":"reg1"},"color":"red"},{"text":"% Alt:","color":"red"},{"score":{"name":"#altitude","objective":"reg1"},"color":"red"},{"text":" Wpn:","color":"red"},{"score":{"name":"@s","objective":"plane-weapon"},"color":"red"},{"text":" Ammo:{wpn1:","color":"red"},{"score":{"name":"#ammunition1","objective":"reg1"},"color":"red"},{"text":" wpn2:","color":"red"},{"score":{"name":"#ammunition2","objective":"reg1"},"color":"red"},{"text":" wpn3:","color":"red"},{"score":{"name":"#ammunition3","objective":"reg1"},"color":"red"},{"text":"}","color":"red"}]
