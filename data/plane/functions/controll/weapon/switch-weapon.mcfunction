...
#オフハンド入れ直し
execute if data entity @s Inventory[{Slot:-106b}] run replaceitem block 0 6 0 container.1 minecraft:stone_button
data modify block 0 6 0 Items[{Slot:1b}].Count set from entity @s Inventory[{Slot:-106b}].Count
data modify block 0 6 0 Items[{Slot:1b}].id set from entity @s Inventory[{Slot:-106b}].id
data modify block 0 6 0 Items[{Slot:1b}].tag set from entity @s Inventory[{Slot:-106b}].tag
