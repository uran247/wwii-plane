...
#オフハンド入れ直し
execute if data entity @s Inventory[{Slot:-106b}] unless data entity @s Inventory[{Slot:-106b,tag:{item-type:indicator}}] run replaceitem block 0 6 0 container.1 minecraft:stone_button
execute unless data entity @s Inventory[{Slot:-106b,tag:{item-type:indicator}}] run data modify block 0 6 0 Items[{Slot:1b}].Count set from entity @s Inventory[{Slot:-106b}].Count
execute unless data entity @s Inventory[{Slot:-106b,tag:{item-type:indicator}}] run data modify block 0 6 0 Items[{Slot:1b}].id set from entity @s Inventory[{Slot:-106b}].id
execute unless data entity @s Inventory[{Slot:-106b,tag:{item-type:indicator}}] run data modify block 0 6 0 Items[{Slot:1b}].tag set from entity @s Inventory[{Slot:-106b}].tag
...
loot give @s mine 0 6 0 air{load:1b}
replaceitem block 0 6 0 container.1 minecraft:air
