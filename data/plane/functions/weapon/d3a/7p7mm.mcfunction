...
summon minecraft:area_effect_cloud ~ ~ ~ {NoGravity:1,Tags:[projectile,gun,7p7mm,gun-init,left,gun-nohit,tracer-lightblue,entity-nohit,offset-base],Duration:200}
