...
execute at 0-0-a-0-0 run particle minecraft:dust 1 1 1 200 ~ ~4 ~ 15 0 0.01 0 25 force
execute at 0-0-a-0-0 run particle minecraft:dust 1 1 1 200 ~ ~4 ~ 0.01 0 15 0 25 force
