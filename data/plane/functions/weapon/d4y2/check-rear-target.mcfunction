...
#機体上側方向に敵がいるか判定
execute at @s facing entity 0-0-4-0-0 feet as @e[tag=rear-gun-target-candidate,distance=..48] positioned ^ ^ ^512 run tag @s[distance=..512] remove rear-gun-target-candidate
