...
#召喚
execute if score #is-tracer reg1 matches 0 run summon minecraft:armor_stand ~ ~ ~ {NoGravity:1,Invisible:1,Tags:[projectile,gun,7p7mm,gun-init,right,tracer-lightblue,tracer,entity-nohit,offset-base],Duration:25}
execute if score #is-tracer reg1 matches 0 run summon minecraft:armor_stand ~ ~ ~ {NoGravity:1,Invisible:1,Tags:[projectile,gun,7p7mm,gun-init,left,tracer-lightblue,tracer,entity-nohit,offset-base],Duration:25}
...
scoreboard players set @e[tag=gun-init,tag=left,distance=..5] offsetX 110
scoreboard players set @e[tag=gun-init,tag=left,distance=..5] offsetY -1850
scoreboard players set @e[tag=gun-init,tag=left,distance=..5] offsetZ -6100
scoreboard players set @e[tag=gun-init,tag=right,distance=..5] offsetX -400
scoreboard players set @e[tag=gun-init,tag=right,distance=..5] offsetY -1850
scoreboard players set @e[tag=gun-init,tag=right,distance=..5] offsetZ -6100
