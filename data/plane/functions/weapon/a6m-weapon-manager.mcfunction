...
execute if entity @a[tag=weapon-user,scores={rightClick=1..}] if entity @s[scores={plane-weapon=2,w2-reload=..0,ammunition2=..0}] at @s run scoreboard players set @a[tag=weapon-user,scores={rightClick=1..}] rightClick 0
