...
#選択に応じて武器ファンクション実行
execute if entity @a[tag=weapon-user,scores={rightClick=1..}] if entity @s[scores={plane-weapon=1,w1-reload=..0,ammunition1=1..},tag=flying] at @s run function plane:weapon/ki21/bomb

#後部機銃発射（自動発射）
execute if entity @s[scores={w2-reload=..0,ammunition2=1..}] at @s run function plane:weapon/ki21/check-rear1-target
execute if entity @s[scores={w2-reload=..0,ammunition2=1..}] if entity @e[tag=rear-gun-target,distance=..32] at @s run function plane:weapon/ki21/rear-gun1
execute if entity @s[scores={w3-reload=..0,ammunition3=1..}] at @s run function plane:weapon/ki21/check-rear2-target
execute if entity @s[scores={w3-reload=..0,ammunition3=1..}] if entity @e[tag=rear-gun-target,distance=..32] at @s run function plane:weapon/ki21/rear-gun2
execute if entity @s[scores={w4-reload=..0,ammunition4=1..}] at @s run function plane:weapon/ki21/check-rear3-target
execute if entity @s[scores={w4-reload=..0,ammunition4=1..}] if entity @e[tag=rear-gun-target,distance=..32] at @s run function plane:weapon/ki21/rear-gun3
