...
#召喚
summon minecraft:area_effect_cloud ~ ~ ~ {NoGravity:1,Tags:[projectile,gun,20mm,gun-init,right,gun-nohit,tracer-lightblue,entity-nohit,offset-base],Duration:200}
summon minecraft:area_effect_cloud ~ ~ ~ {NoGravity:1,Tags:[projectile,gun,20mm,gun-init,left,gun-nohit,tracer-lightblue,entity-nohit,offset-base],Duration:200}
