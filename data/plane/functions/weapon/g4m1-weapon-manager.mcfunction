...
#選択に応じて武器ファンクション実行
execute if entity @p[tag=weapon-user,scores={rightClick=1..}] if entity @s[scores={plane-weapon=1,w1-reload=..0,ammunition1=1..,AngX=..1600,AngZ=-1000..1000},tag=flying] at @s run function plane:weapon/g4m1/bomb
...
execute if entity @s[scores={w3-reload=..0,ammunition3=1..}] if entity @e[tag=rear-gun-target,distance=..55] at @s run function plane:weapon/g4m1/rear-gun2
execute if entity @s[scores={w4-reload=..0,ammunition4=1..}] at @s run function plane:weapon/g4m1/check-rear3-target
execute if entity @s[scores={w4-reload=..0,ammunition4=1..}] if entity @e[tag=rear-gun-target,distance=..55] at @s run function plane:weapon/g4m1/rear-gun3
execute if entity @s[scores={w5-reload=..0,ammunition5=1..}] at @s run function plane:weapon/g4m1/check-rear4-target
execute if entity @s[scores={w5-reload=..0,ammunition5=1..}] if entity @e[tag=rear-gun-target,distance=..55] at @s run function plane:weapon/g4m1/rear-gun4
execute if entity @s[scores={w6-reload=..0,ammunition6=1..}] at @s run function plane:weapon/g4m1/check-rear5-target
execute if entity @s[scores={w6-reload=..0,ammunition6=1..}] if entity @e[tag=rear-gun-target,distance=..55] at @s run function plane:weapon/g4m1/rear-gun5
