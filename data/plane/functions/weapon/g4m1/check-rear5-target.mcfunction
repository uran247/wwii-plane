...
execute as 0-0-4-0-0 run scoreboard players set @s offsetY 1900
execute as 0-0-4-0-0 run scoreboard players set @s offsetZ 4000
execute as 0-0-a-0-0 run scoreboard players set @s offsetX 50
execute as 0-0-a-0-0 run scoreboard players set @s offsetY 2000
execute as 0-0-a-0-0 run scoreboard players set @s offsetZ 3500
