...
#n発目の弾なら曳光弾化
scoreboard players operation #is-tracer reg1 = @s ammunition4
...
scoreboard players set @e[tag=gun-init,distance=..5] offsetY 2000
scoreboard players set @e[tag=gun-init,distance=..5] offsetZ 3500
