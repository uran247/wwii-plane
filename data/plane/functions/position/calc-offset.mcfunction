...
#座標取得
execute store result score @s reg1 run data get entity @s Pos[0] 1000
execute store result score @s reg2 run data get entity @s Pos[1] 1000
execute store result score @s reg3 run data get entity @s Pos[2] 1000
...
execute store result score @s reg4 run data get entity @e[type=minecraft:area_effect_cloud,tag=indicatorX,limit=1,sort=nearest] Pos[0] 1000
execute store result score @s reg5 run data get entity @e[type=minecraft:area_effect_cloud,tag=indicatorX,limit=1,sort=nearest] Pos[1] 1000
execute store result score @s reg6 run data get entity @e[type=minecraft:area_effect_cloud,tag=indicatorX,limit=1,sort=nearest] Pos[2] 1000
...
execute store result score @s reg7 run data get entity @e[type=minecraft:area_effect_cloud,tag=indicatorY,limit=1,sort=nearest] Pos[0] 1000
execute store result score @s reg8 run data get entity @e[type=minecraft:area_effect_cloud,tag=indicatorY,limit=1,sort=nearest] Pos[1] 1000
execute store result score @s reg9 run data get entity @e[type=minecraft:area_effect_cloud,tag=indicatorY,limit=1,sort=nearest] Pos[2] 1000
...
#tellraw @a [{"text":"X: "},{"score":{"name":"@s","objective":"reg7"}},{"text":"Y: "},{"score":{"name":"@s","objective":"reg8"}},{"text":"Z: "},{"score":{"name":"@s","objective":"reg9"}}]
#tellraw @a [{"text":"X: "},{"score":{"name":"@s","objective":"reg1"}},{"text":"Y: "},{"score":{"name":"@s","objective":"reg2"}},{"text":"Z: "},{"score":{"name":"@s","objective":"reg3"}}]

#移動
execute store result entity @s Pos[0] double 0.000001 run scoreboard players get @s reg1
execute store result entity @s Pos[1] double 0.000001 run scoreboard players get @s reg2
execute store result entity @s Pos[2] double 0.000001 run scoreboard players get @s reg3
