...
execute store result entity @s Pos[1] double 0.001 run scoreboard players get #offset-y reg1
execute store result entity @s Pos[2] double 0.001 run scoreboard players get #offset-z reg1
