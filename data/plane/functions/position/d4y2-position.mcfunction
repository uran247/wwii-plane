...
execute as @s[tag=bombed,scores={reg1=0}] if score @s ammunition2 = @s max-ammunition2 at @s store success score #summoned-bomb reg1 run function plane:summon/d4y2/d4y2-bomb
execute as @s[tag=rocketted,scores={reg2=0}] if score @s ammunition4 = @s max-ammunition4 at @s store success score #summoned-rocket reg1 run function plane:summon/d4y2/d4y2-rocket
